...
public class FieldController extends BaseController {
    ...
    public void getFieldDataType(HttpServletRequest request, HttpServletResponse response) {
        try {
            this.sendData(request, response, fieldService.getFieldDataType(getUserId()));
        } catch (ServiceException e) {
            this.sendError(request, response, "获取列表失败！");
        }
    }
    ...
    public void getFieldByDataType(HttpServletRequest request, HttpServletResponse response) {
        try {
            this.sendData(request, response, fieldService.getAllEngineRawFieldByPerm(getUserId()));
        } catch (ServiceException e) {
            this.sendError(request, response, "获取列表失败！");
        }
    }
...
//                ruleSetService.deleteRedisCache(engineRules.getId(),false);
