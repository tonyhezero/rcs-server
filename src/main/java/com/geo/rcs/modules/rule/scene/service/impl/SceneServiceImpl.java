...
public class SceneServiceImpl implements SceneService {
    ...
    public String getBusinessNameById(Integer id){
        return sceneMapper.getBusinessNameById(id);
    }

    @Override
    public List<Integer> getBusinessIdByName(String businessName, Long uniqueCode) {
        return sceneMapper.getBusinessIdByName(businessName,uniqueCode);
    }

    @Override
    public List<Long> getSceneIdByName(String sceneName,Integer businessId,Long uniqueCode) {
        return sceneMapper.getSceneIdByName(sceneName,businessId,uniqueCode);
    }

    @Override
    public List<Long> getSceneOldIdByName(String sceneName) {
        return sceneMapper.getSceneOldIdByName(sceneName);
    }
