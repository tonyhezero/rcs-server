...
public interface EngineSceneMapper {
    ...
    String getBusinessNameById(Integer id);

    List<Integer> getBusinessIdByName(@Param("businessName") String businessName, @Param("uniqueCode") Long uniqueCode);

    List<Long> getSceneIdByName(@Param("sceneName") String sceneName, @Param("businessId") Integer businessId, @Param("uniqueCode") Long uniqueCode);

    List<Long> getSceneOldIdByName(@Param("sceneName") String sceneName);
}