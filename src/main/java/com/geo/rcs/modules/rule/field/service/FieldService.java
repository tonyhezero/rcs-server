...
public interface FieldService {
    ...
    List<EngineInter> findInterById(String[] ids);

    List<EngineField> findFieldById(String[] ids);

    List<Map<String,Object>> findEntryMapByFieldId(Long userId);
    ...
    List<FieldDataType> getFieldDataType(Long uniqueCode) throws ServiceException;
    ...
    List<EngineField> getAllEngineRawFieldByPerm(Long id) throws ServiceException;
     ...
     * @return
     */
    List<EngineRawField> findFieldsByInterName(String name);

    /**
     * 获取所有字段的id，name,describ,field_type
     * 作用：映射信息
     * @return
     */
    List<Map> getFieldMappingInfo();

    int deleteByPrimaryInterId(Long inter_id);
}
