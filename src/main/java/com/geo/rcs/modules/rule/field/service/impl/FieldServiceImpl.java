...
public class FieldServiceImpl implements FieldService{
    ...
    @Override
    public  List<EngineInter> findInterById(String[] ids) {
        return engineFieldMapper.findInterByFieldId(ids);
    }

    @Override
    public List<EngineField> findFieldById(String[] ids) {
        return engineFieldMapper.findFieldByFieldId(ids);
    }

    @Override
    public List<Map<String,Object>> findEntryMapByFieldId(Long userId) {
        return engineFieldMapper.findEntryMapByFieldId(userId);
    }
    ...
    @Override
    public List<FieldDataType> getFieldDataType(Long uniqueCode){
        return engineRawFieldMapper.getFieldDataType(uniqueCode);
    }
    ...
    @Override
    public List<EngineField> getAllEngineRawFieldByPerm(Long id) throws ServiceException {
        return engineFieldMapper.getAllEngineRawFieldByPerm(id);
    }
    ...
    @Override
    public List<EngineRawField> findFieldsByInterName(String name){
        return engineRawFieldMapper.findFieldsByInterName(name);
    }

    @Override
    public List<Map> getFieldMappingInfo(){
        return engineRawFieldMapper.getFieldMappingInfo();
    }

    @Override
    public int deleteByPrimaryInterId(Long inter_id) {
        return engineRawFieldMapper.deleteByPrimaryInterId(inter_id);
    }
