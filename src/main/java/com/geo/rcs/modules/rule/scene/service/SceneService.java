...
public interface SceneService {
    ...
    List<Integer> getBusinessIdByName(String businessName, Long uniqueCode);

    List<Long> getSceneIdByName(String sceneName, Integer businessId, Long uniqueCode);

    List<Long> getSceneOldIdByName(String sceneName);
}
