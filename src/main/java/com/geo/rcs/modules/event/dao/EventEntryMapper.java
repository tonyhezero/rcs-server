...
public interface EventEntryMapper {
    ...
    Page<EventEntry> findByPageForRules(EventEntry record);

    Page<EventEntry> findByPageForDecision(EventEntry record);

    Page<EventEntry> findByPageForApi(EventEntry record);

    Page<EventEntry> findByPageForWeb(EventEntry record);

    Page<EventEntry> findByPageForTest(EventEntry record);
    ...
    /**获取字段中英文匹配*/
    List<Map<String,String>> getMappingName();

    List<Map<String,String>> selectFieldByName(String name);
}