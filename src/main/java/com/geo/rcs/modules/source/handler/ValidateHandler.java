...
public class ValidateHandler {
    ...
    public static final String GEO_ZXW="geozxw";
    ...
    private static final List<String> validInterSet = Arrays.asList("A3", "A4", "B7", "B13",
            ...
            "A5", "C2", "B21", "B1", "T20105", "T10103","TONG_DUN_ANTIFRAUD","B8","B9");
    ...
    public static final String MULTIFIELD_1_1 = "multiField_1_1";
    //同盾接口解析方式1
    ...
    static {
        ...
        interfaceDic.put("singleField_1", Arrays.asList("A1","A3", "A4", "B7", "B13", "A2", "C8", "C9", "D1", "D3",
                "B11", "B18", "B19", "C1", "C7", "Z4", "Z5",
                "A5", "C2", "B21", "B1","B8","B9","D13","B17","C13","B12","C10","C12","S1","Y5","T40308","D10"
        ));
        /**
         * geo单字段特殊类型
         * 特殊： "RSL":[{"RS":{"code":"-9999","desc":" ZTE-NX511J"},"IFT":"C6"}]
         */
        interfaceDic.put("singleField_2", Arrays.asList("C6","Z20"));
         ...
         */
        interfaceDic.put("multiField_1", Arrays.asList("Y1", "Y4", "T20103","T10204", "Y3", "T20107","T10103","T10111","T40306","T40307","T40308"));

        /**
         * 多维字段数据类型一的子类型：
         * 将字段设定为"illegal_"+验证返回的key
         */
        interfaceDic.put("multiField_1_1", Arrays.asList("T10103"));
         ...
         *              \"CSSP001\":\"3\",\"score\":null}]}"},"IFT":"Z7"}]
         */
        interfaceDic.put("multiField_2", Arrays.asList("Z7","INDC501000","INDC201000"));
         ...
         */
        interfaceDic.put("multiField_3", Arrays.asList("T40303", "T40301", "T40302", "T10106","T40305","E001","E002"));
        ...
        interfaceDic.put("multiField_5",Arrays.asList("INDX103000","INDX104000","INDX204000","INDX303001","INDX304000","INDX403000","INDX509000","INDX103070","INDX808000","INDX803000"));
    ...
    static{
        ...
        inter2Field.put("B8","workPlaceValidate");
        inter2Field.put("B9","residenceValidate");
        ...
        inter2Field.put("D13","consumptionMean");
        inter2Field.put("B17","secondaryNumbering");
        inter2Field.put("C13","phoneRating");
        inter2Field.put("B12","callTimeInTheLastThreeMonths");
        inter2Field.put("C10","phoneNumberPayment");
        inter2Field.put("A1","realNameMobilePhone");
        inter2Field.put("C12","mobilePhoneNumberBlacklist");
        inter2Field.put("S1","capabilityAssessment");
        inter2Field.put("Y5","familyStatus");
        inter2Field.put("T40308","backList");
        /* part3 */
        ...
        inter2Field.put("Z20","cardandcardtype");
        inter2Field.put("D10","numberRealTimeStatus");
