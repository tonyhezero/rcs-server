...
public class SysUserServiceImpl implements SysUserService {
	...
	public void updateUser(SysUser user) {
		...
		if(user.getCustomer().getId() != null){
			cus = customerMapper.findByUserId(user.getId());
	...
	public void updateCustomer(Customer customer) throws ServiceException {
		...
		Customer cus = customerMapper.findByUserId(customer.getUserId());
		if (cus == null){
			customer.setDsign(1);
	...
	public Map<String, Object> getCustomerInfo(Long userId) {
		...
		if (customer == null){
			...
			customer.setServer("http://zxw-api.geotmtai.com");
		}
		data.put("customer",customer);

		CustomerZxw customerZxw = customerMapper.findZxwByUserId(userId);
		if (customerZxw == null){
			customerZxw = new CustomerZxw();
			customerZxw.setServer("http://zxw-api.geotmtai.com");
		}
		data.put("customerZxw",customerZxw);

		return data;
	}

	/*@Override
	public void addCustomerZxw(CustomerZxw customerZxw) {

		customerZxw.setDsign(1);
		sysUserMapper.addCustomerZxw(customerZxw);

	}*/

	@Override
	public void updateCustomerZxw(CustomerZxw customerZxw) {

		CustomerZxw zxw = sysUserMapper.findCusZxwByUserId(customerZxw.getUserId());
		if (zxw == null){
			customerZxw.setDsign(1);
			sysUserMapper.addCustomerZxw(customerZxw);
		}else{
			sysUserMapper.updateCusZxwByUserId(customerZxw);
		}
	}
