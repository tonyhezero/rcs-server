...
public class Condition {
    ...
    public String getFieldResultJs() {
        return fieldResultJs;
    }

    public void setFieldResultJs(String fieldResultJs) {
        this.fieldResultJs = fieldResultJs;
    }
}
