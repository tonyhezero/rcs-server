...
public interface ApprovalService {
    ...
    void publicRuleSet(Approval approval);
    ...
    void publicToApproval(Approval approval) throws ServiceException;

    void cancelApproval(Long id);

    void deleteDecisionToApproval(Approval approval);

    void deleteByPrimaryKey(Approval approval);
}
