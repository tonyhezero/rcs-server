...
public class BaseController {
	...
	public void sendData(HttpServletRequest request, HttpServletResponse response, Object data) {
		...
		try {
			sendJson(request, response, JSON.toJSONString(jsonw.getWrap(), SerializerFeature.WriteNullStringAsEmpty, SerializerFeature.WriteMapNullValue, SerializerFeature.WriteNullListAsEmpty));
		} catch (Exception e) {
