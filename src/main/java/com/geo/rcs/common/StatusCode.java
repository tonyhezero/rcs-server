...
public enum StatusCode {
	...
	DATA_SOURCE_ZXW_DENIED(4032,"中小微平台数据源未配置或配置错误，请配置中小微数据源账号信息"),
	...
	RULE_SENCE_ERROR(4032, "规则集配置未完成，业务或场景字段缺失"),
	...
	GOAL_NOTFOUND_ERROR(4043,"暂无节点信息"),
	...
	DECISION_ENGINE_EXCEPTION(10000,"递归次数达100次,决策引擎发生异常!"),
	/**
	 * 数据源权限
	 */
	DATA_SOURCE_ERROR(40000,"该用户为具有访问权限,请勾选接口"),
	;
